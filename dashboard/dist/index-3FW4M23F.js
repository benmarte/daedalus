...
var __HERMES_DAEDALUS_DASHBOARD__ = (() => {
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "span",
              { style: S.modalTitle },
              props.setupMode ? "Configure: " + name + " \xB7 Step 2 of 2" : "Edit: " + name
            ),
            React.createElement("button", { style: S.btnSmall, onClick: props.onClose }, "\xD7")
          ),
          ...
          React.createElement(
            ...
            React.createElement(
              "label",
              { style: Object.assign({}, S.field, { flexDirection: "row", alignItems: "center", gap: "10px", cursor: "pointer" }) },
              React.createElement("input", {
                type: "checkbox",
                checked: !!getIn(config, ["execution", "auto_merge"], false),
                onChange: function(e2) {
                  updateField("execution.auto_merge", e2.target.checked);
                },
          ...
          getIn(config, ["execution", "auto_merge"], false) ? React.createElement(
            "div",
            { style: S.fieldRow },
            React.createElement(
              "label",
              ...
              React.createElement(
                "select",
                {
                  ...
                  onChange: function(e2) {
                    updateField("execution.merge_method", e2.target.value);
                  }
                },
            ...
            return React.createElement(
              ...
              React.createElement(
                ...
                React.createElement("input", {
                  ...
                  onChange: function(e2) {
                    updateField("execution.coding_agent_cmd", e2.target.value);
                  }
                }),
                React.createElement(
                  "div",
    ...
    function applyDetected(d) {
      ...
      if (d.vcs_extra && Object.keys(d.vcs_extra).length > 0) {
        setExtra(function(prev) {
          return Object.assign({}, prev, d.vcs_extra);
        });
      }
    }
    useEffect(function() {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          { style: S.modalHeader },
          React.createElement("span", { style: S.modalTitle }, "Add Project \xB7 Step 1 of 2"),
          React.createElement("button", { style: S.btnSmall, onClick: props.onClose }, "\xD7")
        ),
        React.createElement(
          "p",
          { style: { fontSize: "13px", color: "#888", margin: "0 0 16px" } },
  ...
  function App() {
    ...
    var sp = useState(null);
    var setupProject = sp[0], setSetupProject = sp[1];
    ...
    var lv = useState(null);
    var latestVersion = lv[0], setLatestVersion = lv[1];
    ...
    var syncProfiles = sp[0], setSyncProfiles = sp[1];
    var sr = useState(null);
    var syncResult = sr[0], setSyncResult = sr[1];
    var load = useCallback(function() {
      setLoading(true);
      setLoadErr(null);
    ...
    function syncProfilesModel() {
      ...
      setSyncResult(null);
      fetchJSON("/api/plugins/daedalus/profiles/model/sync", { method: "POST" }).then(function(r) {
    ...
    return React.createElement(
      ...
      syncResult ? React.createElement(
        ...
        syncResult.ok ? "Synced " + syncResult.updated + " profile(s) to " + (syncResult.model || "global model") : "Sync error: " + (syncResult.error || "failed")
      ) : null,
      ...
      showAddProject ? React.createElement(AddProjectModal, {
        ...
        onRegistered: function(name) {
          setShowAddProject(false);
          setSetupProject(name);
        }
      }) : null,
