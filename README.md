...
| `documentation-daedalus` | READMEs, ADRs, completion report posted to the PR and chat channels. `CHANGELOG.md` is **not** edited by the docs agent — it is auto-generated by the CI workflow post-merge (#1179). Waits for reviewer, security-analyst, and accessibility (when assigned) to clear. | No |
